...
# Bilgi : Lidar kullanarak etrafondaki engelleri algılar. Hesaplama yaparak engel konumu bulmaktadır. 
          Ardından location konusuna bunu dizi olarak paylaşır. dizinin ilk elemanı aracın konumudur. 
...
class Control():
    def __init__(self):
        ...
        # Bayraklar
        self.cur_action = 'gf'  # 'tl': sola dön; 'tr': sağa dön; 'fw': düz ilerle

        # Set parameters for actions
        self.next_action_time = rospy.Time.now()  # zaman hareketi başlıyor
        self.safe_distance = 2.0  # bir engele yakalaşılacak min nokta
        self.goal_tolarence = 1.5  # hedefe olan tolerans
    ...
    def shutdown(self):
        ...
        self.cmd_vel_pub.publish(AckermannDrive())
        rospy.sleep()
...
if __name__ == '__main__':
    ...
    bol = rospy.Subscriber('basla', Bool, bool_callback)
    #pub = rospy.Publisher('liste_boyut', Int16, queue_size=10)

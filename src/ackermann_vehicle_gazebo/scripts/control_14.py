...
"""
# Bilgi : Robotu hareket ettirir ve hedefe ulaşınca durdurur. Bunun için object_detection.py ve RRT_12.py dosyalarını kullanır.
...
if __name__ == '__main__':
    ...
    bol_1 = rospy.Subscriber('basla_1', Bool, bool_callback)
    #array_size = rospy.Subscriber("/array_size", Int16, array_callback)
    rospy.spin()
